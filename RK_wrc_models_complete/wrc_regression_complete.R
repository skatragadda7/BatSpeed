...
model_comparisons <- data.frame(
  ...
  Year = c(rep("2024",2), rep("2025",2)),
  RMSE = c(LinReg_metrics_2024$.estimate[1], RF_metrics_2024$.estimate[1], 
           LinReg_metrics_2025$.estimate[1], RF_metrics_2025$.estimate[1]),
  R2 = c(LinReg_metrics_2024$.estimate[2], RF_metrics_2024$.estimate[2], 
           LinReg_metrics_2025$.estimate[2], RF_metrics_2025$.estimate[2]),
  MAE = c(LinReg_metrics_2024$.estimate[3], RF_metrics_2024$.estimate[3], 
         LinReg_metrics_2025$.estimate[3], RF_metrics_2025$.estimate[3])
)
model_comparisons
